...
def run_pass(
    ...
    prompt = (
        ...
        "Copy each target string literally into BOTH attempt and observed_result; do not abbreviate, redact, "
        "or replace path segments. Example target=crates/liminal-xtask/src/haq.rs:123, "
        "attempt='falsify crates/liminal-xtask/src/haq.rs:123 by changing this predicate', "
        "observed_result='verifier accepted the mutation at crates/liminal-xtask/src/haq.rs:123'. "
