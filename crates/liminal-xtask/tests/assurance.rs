...
fn fixture() -> std::path::PathBuf {
    ...
    std::fs::write(root.join("verification/assurance/catalog.json"), serde_json::to_vec_pretty(&serde_json::json!({
        ...
        "profiles": {
            ...
            "merge": ["style", "lint", "tracked-sizes", "fuzz-lock", "bootstrap", "proof-support", "nextest", "host", "partition", "threaded", "doctest", "docs", "deny", "inventory", "canaries", "resource-run", "resource-lint", "assurance"],
