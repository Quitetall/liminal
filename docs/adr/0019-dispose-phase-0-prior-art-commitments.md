...
|---|---|---|---|---|
| Salsa | Adopt | pure tracked queries, external input mutation, revisioned dependencies, durability-informed invalidation | M08 deterministic replay and effect-reactor separation; proposed ADR-0017 | Phase 1 spike cannot express Workspace Basis, diagnostics, or bounded invalidation without hidden global state |
...
particular, ADR-0017 decides Salsa use; this ADR does not pre-accept that choice.
